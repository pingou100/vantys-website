...
<section class="hero">
    ...
    <div class="container">
        ...
        <div class="contact-form-container">
            ...
            ${contactContent.vat && contactContent.vat.trim() ? `<p style="margin-top:24px;font-size:.85em;color:var(--gray);text-align:center">Vantys SRL<br>VAT: ${contactContent.vat.trim()}</p>` : ''}
        </div>
        ${addrHtml}
    </div>
</section>
